        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="mb-3 leading-none logo-container">
              <h3 className={`text-2xl tracking-wider ${colors.text} logo-outline`} style={{ fontFamily: 'SilentBrush, "Silkscreen", system-ui', letterSpacing: '0.02em', fontWeight: 400 }}>SKUT</h3>
              <p className={`text-xs tracking-wider ${colors.text} logo-outline`} style={{ fontFamily: 'SilentBrush, "Silkscreen", system-ui', letterSpacing: '0.02em', marginTop: '-2px', fontWeight: 400 }}>APPAREL</p>
            </div>
