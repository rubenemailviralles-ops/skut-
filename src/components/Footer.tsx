        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="mb-3 leading-none logo-container">
              <h3 className={`text-2xl tracking-wider ${colors.text} logo-outline`} style={{ fontFamily: '"Orbitron", sans-serif', letterSpacing: '0.1em', fontWeight: 900 }}>SKUT</h3>
              <p className={`text-xs tracking-wider ${colors.text} logo-outline`} style={{ fontFamily: '"Orbitron", sans-serif', letterSpacing: '0.1em', marginTop: '-2px', fontWeight: 900 }}>APPAREL</p>
            </div>
